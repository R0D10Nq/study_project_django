"""
Django settings for django_landings project.
...
SECRET_KEY = 'django-insecure-9*%b^&b@9pl@bi0t=4+9vj6x&j+ch1-g2hcsvup6lfawdx@9@9'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['allsmiles-impl-redesign.blank.sinergium-local.ru', 'localhost', '127.0.0.1']
...
INSTALLED_APPS = [
	...
	'core',
	'_sites.allsmiles_impl_redesign__blank__sinergium__ru',
]
...
WSGI_APPLICATION = 'django_landings.wsgi.application'
